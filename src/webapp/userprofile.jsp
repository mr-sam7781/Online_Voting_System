...
<link rel="stylesheet" type="text/css" href="css/userprofile.css">
	...
	<style type="text/css"> <%@ include file="css/userprofile.css" %> </style>	
</head>
<body>
<%
 Connection cn =null;
...
String sql="select * from user_signup where Adhar_Number ='"+session.getAttribute("Adhar_Number")+"'";
...
%>
    ...
    <div class="profile-container">
        <div class="profile-image">
            <img src="images/<%=rs.getString("Image") %>" alt="User Profile Picture">
        </div>
