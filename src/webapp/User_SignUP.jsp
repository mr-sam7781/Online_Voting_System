...
<div class="form-group">
<input type="number"  maxlength="10"  name="Mobile_Number" placeholder="Enter Mobile Number" maxlength="10" onkeypress="return isNumber(event)">
</div>
</div>
<div class="form-row">
<div class="form-group">       
...
<div class="form-group">
<input type="text" name="District" placeholder="District" onkeypress="return isString(event)">
</div>
</div>
<div class="address">
<div class="address">
...
<div class="form-group">
<input type="number" maxlength="12"  name="Adhar_Number"  placeholder="Enter Adhar Number" required>
</div>
</div>
<div class="form-row">
<div class="form-group">
