...
/**
 * Servlet implementation class Candidate_SignUP
 */
public class Candidate_SignUP extends HttpServlet {
	...
	out.println(result);
	 ...
	 if (event.equals("Submit"))
	 {
		if(	First_Name.equals("")||Middle_Name.equals("")|| last_Name.equals("")||	Email_ID.equals("")|| Mobile_Number.equals("")||gender.equals("")|| State.equals("")|| District.equals("")|| Address.equals("")|| Voter_ID.equals("")||Adhar_Number.equals("")||Password.equals("")|| Confirm_Password.equals("")|| Birth_Date.equals("")||VoterIDCard.equals("")||AdharCard.equals("")||Image.equals("") )
		{
			...
			out.println(" <script type=\"text/javascript\"> alert('Please fill in all the required fields'); location= 'Candidate_SignUP.jsp'; </script>");     
		...
		else
		{
			try
			{
				String sql= " insert into candidate_signup(First_Name,Middle_Name,last_Name,Email_ID,Mobile_Number,gender,State,District,Address,Voter_ID,Adhar_Number,Password,Confirm_Password,Birth_Date,VoterIDCard,AdharCard,Image) values ('"+First_Name+"',  '"+Middle_Name+"',  '"+last_Name+"', '"+Email_ID+"', '"+Mobile_Number+"', '"+gender+"', '"+State+"', '"+District+"', '"+Address+"', '"+Voter_ID+"', '"+Adhar_Number+"', '"+Password+"', '"+Confirm_Password+"', '"+Birth_Date+"' , '"+VoterIDCard+"', '"+AdharCard+"', '"+Image+"')";
				String insert = db.Insert(sql);
				out.println(insert);
				resp.setContentType("text/html");
				out.println(" <script type=\"text/javascript\"> alert('Resistration Successful'); location= 'candidate_dashbord.jsp'; </script>");
			} 
			catch(Exception ex)
			{		
